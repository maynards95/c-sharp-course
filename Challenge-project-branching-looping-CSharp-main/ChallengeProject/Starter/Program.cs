...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "3":
            ...
            for (int i = 0; i < maxPets - 1; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 2] == "Age: " || ourAnimals[i, 2] == "Age: ?")
                    {
                        ...
                        do
                        {
                            Console.WriteLine("Age incomplete, please enter the animal's age for animal " + ourAnimals[i, 0]);
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                animalAge = readResult;
                    ...
                    if (ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd")
                    {
                        ...
                        do
                        {
                            Console.WriteLine("Physical description incomplete, please enter the animal's age for animal " + ourAnimals[i, 0]);
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                if (readResult != "")
            ...
            Console.WriteLine("All data requirements met");
            Console.WriteLine("Press the Enter key to continue.");
            readResult = Console.ReadLine();
            break;
            ...
            for (int i = 0; i < maxPets - 1; i++)
            {
                if (ourAnimals[i, 0] != "ID #: ")
                {
                    if (ourAnimals[i, 3] == "Nickname: " || ourAnimals[i, 3] == "Nickname: ?")
                    {
                        ...
                        do
                        {
                            Console.WriteLine("Nickname incomplete, please enter the animal's nickname for animal " + ourAnimals[i, 0]);
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                if (readResult != "")
                    ...
                    if (ourAnimals[i, 5] == "Personality: " || ourAnimals[i, 5] == "Personality:  tbd")
                    {
                        ...
                        do
                        {
                            Console.WriteLine("Personality description incomplete, please enter the animal's personality for animal " + ourAnimals[i, 0]);
                            readResult = Console.ReadLine();
                            if (readResult != null)
                            {
                                if (readResult != "")
